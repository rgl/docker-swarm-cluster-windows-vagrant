...
$backgroundColor = [System.Drawing.Color]::FromArgb(37, 50, 55) #253237
$backgroundPath = 'C:\Windows\Web\Wallpaper\Windows\docker.png'
$logo = [System.Drawing.Image]::FromFile((Resolve-Path 'docker.png'))
